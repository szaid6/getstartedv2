                                ...
                                <form action="{{url('/user/editUser')}}" method="post">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label">User Name <span style="color: red;">&#42</span></label>
                                                    <input type="text" value="{{$data->name}}" class="form-control" name="name">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label">User Email <span style="color: red;">&#42</span></label>
                                                    <input type="email" value="{{$data->email}}" class="form-control" name="email">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label">User Phone <span style="color: red;">&#42</span></label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label">User Role <span style="color: red;">&#42</span></label>
